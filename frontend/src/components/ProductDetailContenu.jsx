...
// previsualisation=true pour désactiver commande réelle + tracking publicitaire).
export default function ProductDetailContenu({ produit, previsualisation = false }) {
    ...
    <div className="product-page-fond">
      <div className="product-page-carte">
        <div className="container" style={{ padding: '2rem 1.5rem' }}>
          {previsualisation ? (
            <span className="eyebrow">← Retour au catalogue</span>
          ) : (
              ...
              {epuise ? (
                ...
                <>
                  ...
                  <div style={{ marginTop: '1.2rem' }}>
                    <InlineOrderForm produit={produit} domId={ID_FORMULAIRE_DEFAUT} previsualisation={previsualisation} />
                  </div>
                </>
              )}
            </div>
